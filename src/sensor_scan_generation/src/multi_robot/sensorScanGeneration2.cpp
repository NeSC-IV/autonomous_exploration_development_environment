                                  ...
                                  const sensor_msgs::PointCloud2ConstPtr& laserCloud2)
{
  ...
  odometryIn.header.frame_id = "robot2/map";
  odometryIn.child_frame_id = "robot2/sensor_at_scan";
  pubOdometryPointer->publish(odometryIn);

  transformToMap.stamp_ = laserCloud2->header.stamp;
  transformToMap.frame_id_ = "robot2/map";
  transformToMap.child_frame_id_ = "robot2/sensor_at_scan";
  ...
  scan_data.header.frame_id = "robot2/sensor_at_scan";
