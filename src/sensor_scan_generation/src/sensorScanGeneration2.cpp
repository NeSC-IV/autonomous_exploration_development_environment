                                  ...
                                  const sensor_msgs::PointCloud2ConstPtr& laserCloud2)
{
  ...
  odometryIn.header.frame_id = "map2";
  odometryIn.child_frame_id = "sensor_at_scan2";
  pubOdometryPointer->publish(odometryIn);

  transformToMap.stamp_ = laserCloud2->header.stamp;
  transformToMap.frame_id_ = "map2";
  transformToMap.child_frame_id_ = "sensor_at_scan2";
  ...
  scan_data.header.frame_id = "sensor_at_scan2";
