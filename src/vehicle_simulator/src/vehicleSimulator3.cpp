/*
 * @Author: jia
 * @Date: 2023-04-19 17:48:49
 * @LastEditors: jia
 * @LastEditTime: 2023-04-19 17:48:51
 * @Description: 请填写简介
 */
#include <math.h>
#include <time.h>
...
void scanHandler(const sensor_msgs::PointCloud2::ConstPtr& scanIn)
{
  ...
  scanData2.header.frame_id = "map2";
...
int main(int argc, char** argv)
{
  ...
  // Modify
  // nhPrivate.getParam("camera", maxIncl);
  // nhPrivate.getParam("lidar", maxIncl);
  // nhPrivate.getParam("robot", maxIncl);
  ...
  odomData.header.frame_id = "map2";
  odomData.child_frame_id = "sensor2";

  tf::TransformBroadcaster tfBroadcaster;
  tf::StampedTransform odomTrans;
  odomTrans.frame_id_ = "map2";
  odomTrans.child_frame_id_ = "sensor2";
